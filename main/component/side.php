...
<aside class="aside is-placed-left is-expanded" style="overflow-y: auto; height: 100vh;">
    <div class="menu is-menu-main">
        ...
        <ul class="menu-list">
            <li>
                <a href="index.php"
                    class="<?php echo ($current_page == 'index.php') ? 'is-active' : ''; ?> router-link-active has-icon">
        ...
        <ul class="menu-list">
            ...
            <li>
                <a
                    class="<?php echo ($current_page == 'appointment.php' || $current_page == 'medical-clearance.php') ? 'is-active' : ''; ?> has-icon has-dropdown-icon">
                ...
                <ul>
                    <li>
                        <a href="appointment.php"
                            class="<?php echo ($current_page == 'appointment.php') ? 'is-active' : ''; ?>">
            ...
            <li>
                <a href="client-table.php"
                    class="<?php echo ($current_page == 'client-table.php') ? 'is-active' : ''; ?> has-icon">
            ...
            <li>
                <a
                    class="<?php echo ($current_page == 'nurse-table.php') ? 'is-active' : ''; ?> has-icon has-dropdown-icon">
                    <span class="icon"><i class="mdi mdi-view-list"></i></span>
            ...
            <li>
                <a
                    class="<?php echo ($current_page == 'medical-clearance.php' || $current_page == 'clearance-table.php') ? 'is-active' : ''; ?> has-icon has-dropdown-icon">
                    <span class="icon"><i class="mdi mdi-view-list"></i></span>
                ...
                <ul>
                    ...
                    <li>
                        <a href="clearance-table.php"
                            class="<?php echo ($current_page == 'clearance-table.php') ? 'is-active' : ''; ?>">
            ...
            <li>
                <a href="nurse-medical-history.php"
                    class="<?php echo ($current_page == 'nurse-medical-history.php') ? 'is-active' : ''; ?> has-icon">
                    <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
                    <span class="menu-item-label">Appointment History</span>
                </a>
            </li>
            <li>
                <a href="nurse-medical-record.php"
                    class="<?php echo ($current_page == 'nurse-medical-record.php') ? 'is-active' : ''; ?> has-icon">
                    <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
        ...
        <ul class="menu-list">
            <li>
                <a href="clinic-inventory.php"
                    class="<?php echo ($current_page == 'clinic-inventory.php') ? 'is-active' : ''; ?> has-icon">
        ...
        <ul class="menu-list">
            <li>
                <a href="admin-nurse-accounts.php"
                    class="<?php echo ($current_page == 'admin-nurse-accounts.php') ? 'is-active' : ''; ?> has-icon">
                    <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
        ...
        <ul class="menu-list">
            ...
            <li>
                <a href="account-management.php"
                    class="<?php echo ($current_page == 'account-management.php') ? 'is-active' : ''; ?> has-icon">
                    <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
            ...
            <li>
                <a href="profile.php"
                    class="<?php echo ($current_page == 'profile.php') ? 'is-active' : ''; ?> has-icon">
