    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form id="register-form" method="POST" class="login100-form validate-form">
                    <span class="login100-form-title p-b-43" style="color: #134280;">
                        <h3 style="font-size: 2rem; font-weight: bold; color: #134280 !important;">Welcome Back!</h3>
                        <h6 style="margin-top: 1vh; font-weight: 100; font-size: 1rem; color: #134280 !important;">
                            Already have an account?
                            <a href="index.php" style="font-weight: 100; font-size: 1rem; color: #134280;">Login</a>
                        </h6>
                    </span>

                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="number" oninput="limitLength(this)"  min="100000" max="999999" name="schoolID">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" name="middlename">
                        <span class="focus-input100"></span>
