                ...
                <div class="b-table has-pagination">
                    <div class="table-wrapper has-mobile-cards">
                        <table class="table is-fullwidth is-striped is-hoverable">
                            ...
                            <tbody>
                                <?php
                                $getClearance = $conn->query("SELECT * 
                                FROM user_slot_clearance 
                                INNER JOIN clearance_slots 
                                ON user_slot_clearance.slot_id = clearance_slots.id 
                                WHERE user_slot_clearance.user_id = '$user_id'");
                                if ($getClearance->num_rows > 0) {
                                    while ($row = $getClearance->fetch_assoc()) {
                                        ...
                                        echo '
                                            ...
                                            $date . '</small>
                                                ...
                                                <td data-label="Status" class="status open">approved</td>
                                            </tr>
                                            ';
                                    }
                                } else {
...
<script>
    function goto() {
        window.location.href="medical-clearance.php";
    }
</script>